...
@Service
@Transactional
public class DepartmentActivityServiceImpl extends GenericServiceImpl<DepartmentActivity> implements DepartmentActivityService {
    @Override
    public DepartmentActivity saveInstance(DepartmentActivity entityInstance) throws ValidationFailedException, OperationFailedException {
        Validate.notNull(entityInstance, "Missing details");
        return save(entityInstance);
    }

    @Override
    public boolean isDeletable(DepartmentActivity instance) throws OperationFailedException {
        return true;
    }
